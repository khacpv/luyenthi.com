 ...
 */
public class Question01SingleChoiceImage extends QuestionLayout {
    public Question01SingleChoiceImage(Context context) {
        super(context);
    }

    public Question01SingleChoiceImage(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
